...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff8_1' => 'get7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff81Service',
            '7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff8_2' => 'get7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff82Service',
            '7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff8_3' => 'get7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff83Service',
            ...
            'dbda4750fe07a49991ceba961b4a9d0337e4ae4387e1ad0da608c5e774d9dc3d_1' => 'getDbda4750fe07a49991ceba961b4a9d0337e4ae4387e1ad0da608c5e774d9dc3d1Service',
    ...
    /**
     * Gets the '7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff8_1' service.
     *
     ...
     */
    protected function get7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff81Service()
    {
        return $this->services['7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff8_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the '7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff8_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff82Service()
    {
        return $this->services['7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff8_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the '7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff8_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff83Service()
    {
        return $this->services['7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff8_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home/leonardo/dev/vhosts/trip-planner/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/leonardo/dev/vhosts/trip-planner/app/Resources');
    ...
    /**
     * Gets the 'dbda4750fe07a49991ceba961b4a9d0337e4ae4387e1ad0da608c5e774d9dc3d_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDbda4750fe07a49991ceba961b4a9d0337e4ae4387e1ad0da608c5e774d9dc3d1Service()
    {
        return $this->services['dbda4750fe07a49991ceba961b4a9d0337e4ae4387e1ad0da608c5e774d9dc3d_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'trip_planner', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('/home/leonardo/dev/vhosts/trip-planner/src/Leopro/TripPlanner/InfrastructureBundle/Resources/config/doctrine/entity' => 'Leopro\\TripPlanner\\Domain\\Entity', '/home/leonardo/dev/vhosts/trip-planner/src/Leopro/TripPlanner/InfrastructureBundle/Resources/config/doctrine/value_object' => 'Leopro\\TripPlanner\\Domain\\ValueObject'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Leopro\\TripPlanner\\Domain\\Entity');
        $b->addDriver($a, 'Leopro\\TripPlanner\\Domain\\ValueObject');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('TripPlannerDomain' => 'Leopro\\TripPlanner\\Domain\\Entity', 'TripPlannerDomainValueObjects' => 'Leopro\\TripPlanner\\Domain\\ValueObject'));
        ...
        $c->setProxyDir('/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_83534061c098b3c91f04ca26af7616a4493d1a7aba902b7e82aa913dfc47c45f');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/leonardo/dev/vhosts/trip-planner/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('dbda4750fe07a49991ceba961b4a9d0337e4ae4387e1ad0da608c5e774d9dc3d_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/leonardo/dev/vhosts/trip-planner/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/home/leonardo/dev/vhosts/trip-planner/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/leonardo/dev/vhosts/trip-planner/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff8_1'), 1 => $this->get('7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff8_2'), 2 => $this->get('7ffcc60ab0372df213fe83d2fac9c0fa1ded87ab9c2702eabe542f4426c3cff8_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/leonardo/dev/vhosts/trip-planner/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/leonardo/dev/vhosts/trip-planner/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/leonardo/dev/vhosts/trip-planner/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/leonardo/dev/vhosts/trip-planner/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/home/leonardo/dev/vhosts/trip-planner/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/leonardo/dev/vhosts/trip-planner/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/home/leonardo/dev/vhosts/trip-planner/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/home/leonardo/dev/vhosts/trip-planner/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/home/leonardo/dev/vhosts/trip-planner/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/home/leonardo/dev/vhosts/trip-planner/app/Resources/views');
        $instance->addPath('/home/leonardo/dev/vhosts/trip-planner/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/home/leonardo/dev/vhosts/trip-planner/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/leonardo/dev/vhosts/trip-planner/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/leonardo/dev/vhosts/trip-planner/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/leonardo/dev/vhosts/trip-planner/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/leonardo/dev/vhosts/trip-planner/app/cache/dev',
            'kernel.logs_dir' => '/home/leonardo/dev/vhosts/trip-planner/app/logs',
            'kernel.bundles' => array(
                ...
                'InfrastructureBundle' => 'Leopro\\TripPlanner\\InfrastructureBundle\\InfrastructureBundle',
            ...
            'debug.container.dump' => '/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/profiler',
            ...
            'router.resource' => '/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/home/leonardo/dev/vhosts/trip-planner/app/../web',
            'assetic.write_to' => '/home/leonardo/dev/vhosts/trip-planner/app/../web',
            'assetic.variables' => array(

            ),
            'assetic.java.bin' => '/usr/bin/java',
            'assetic.node.bin' => '/usr/bin/node',
            'assetic.ruby.bin' => '/home/leonardo/.rvm/rubies/ruby-2.1.0/bin/ruby',
            'assetic.sass.bin' => '/home/leonardo/.rvm/gems/ruby-2.1.0/bin/sass',
            ...
            'doctrine.orm.proxy_dir' => '/home/leonardo/dev/vhosts/trip-planner/app/cache/dev/doctrine/orm/Proxies',
            ...
            'doctrine_migrations.dir_name' => '/home/leonardo/dev/vhosts/trip-planner/app/DoctrineMigrations',
